...
#define LAYOUT_levinson_base( \
  ...
  LAYOUT_wrapper( \
    ...
    KC_BSPC, K11,     K12,     K13,     K14,     K15,           K16,      K17,     K18,     K19,     K1A,     KC_BSLS, \
    ALT_TAB, K21,     K22,     K23,     K24,     K25,           K26,      K27,     K28,     K29,     K2A,     KC_QUOT, \
    OS_LSFT, OS_RCTL, ALT_GRV, OS_LGUI, KC_SPC, BK_LWER,       DL_RAIS,   KC_ENT,  OS_RGUI, OS_RALT, OS_RCTL, OS_RSFT  \
  )
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_RAISE] = LAYOUT_wrapper(
     ...
     KC_MUTE, KC_MSTP, KC_MPLY, KC_VOLD, _______, KC_LAYR,      KC_LAYR, _______, RGB_HUD, RGB_SAD, RGB_VAD, _______
  ),
  ...
  [_ADJUST] = LAYOUT_wrapper(
     ...
     _______, _______, _______, _______, _______, KC_LAYR,       KC_LAYR, _______, _______, _______, _______, _______
  )
};
